...
*/
jQuery(document).ready(function(a){function e()
	{var a=document.createElement("event"),
	e={WebkitTransition:"webkitTransitionEnd",
	MozTransition:"transitionend",transition:"transitionend"};
	for(var s in e)if(void 0!==a.style[s])return e[s]}var s=e();
	a('[data-toggle="offcanvas"], .overlay').click(function(){
		...
		a(".navbar .nav a").click(function(){a(".overlay").removeClass("active"),
		a("body").removeClass("active"),a("#navbar").removeClass("in"),
		a(".row-offcanvas").removeClass("active"),
		a(".sidebar-offcanvas").removeClass("active"),
		a(".navbar-toggle").addClass("collapsed"),
		a(".transition").one(s,function(){
			a(".navbar-collapse").removeClass("transition")})}),
			a(".overlay").on("swiperight",function(){a(".overlay").addClass("active"),
			a("body").addClass("active"),a("#navbar").addClass("in"),
			a(".row-offcanvas").addClass("active"),
			a(".sidebar-offcanvas").addClass("active"),
			a(".navbar-toggle").removeClass("collapsed"),
			a(".navbar-collapse").addClass("transition")}),
			a(".overlay").on("swipeleft",function(){a(".overlay").removeClass("active"),
			a("body").removeClass("active"),a("#navbar").removeClass("in"),
			a(".row-offcanvas").removeClass("active"),
			a(".sidebar-offcanvas").removeClass("active"),
			a(".navbar-toggle").addClass("collapsed"),
